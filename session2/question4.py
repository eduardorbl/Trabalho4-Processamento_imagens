...
def process_images_lagrange(input_folder, output_folder, scale=2.25, display=False):
    """
    Processes images in the input folder by scaling them using Lagrange interpolation 
    ...
    Args:
        ...
        scale (float, optional): Scaling factor for the images. Defaults to 2.25.
    ...
    Notes:
        ...
        - The output images are saved with filenames prefixed by "grid_lagrange_".
    """
    ...
    for image_file in image_files:
        ...
        grid_output_path = os.path.join(output_folder, f"grid_lagrange_{image_file}")
...
if __name__ == "__main__":
    ...
    scale = 0.5
    display = False
    process_images_lagrange(input_folder=input_folder, output_folder=output_folder, scale=scale, display=display)